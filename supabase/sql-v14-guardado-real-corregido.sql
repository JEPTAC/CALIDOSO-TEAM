...
-- =========================================================
-- SQL V14 - GUARDADO GLOBAL REAL
-- Corrige el conflicto 409 en system_settings usando RPC.
-- No borra datos.
-- =========================================================
...
begin
  ...
  set
    setting_value = coalesce(payload, '{}'::jsonb),
    description = 'Configuración global del portal Dream Team Calidad',
    updated_by = auth.uid(),
    updated_at = now()
  where setting_key = 'portal_home_settings_v6';
