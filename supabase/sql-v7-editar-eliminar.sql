...
-- =========================================================
-- SQL V7 - EDITAR Y ELIMINAR
-- No borra datos. Solo asegura permisos de edición/eliminación.
-- =========================================================
...
-- Lectura y escritura autenticada para módulos principales.
...
create policy "app_modules_select_all"
...
create policy "audit_reports_select_all"
...
create policy "app_modules_authenticated_all"
on public.app_modules
for all
to authenticated
using (true)
...
create policy "news_posts_authenticated_all"
on public.news_posts
for all
to authenticated
using (true)
...
create policy "audit_reports_authenticated_all"
on public.audit_reports
for all
to authenticated
using (true)
...
create policy "publications_authenticated_all"
on public.publications
for all
to authenticated
using (true)
